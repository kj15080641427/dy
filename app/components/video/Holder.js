  ...
  render() {
    return (
      <div className="set-rotate-radio" style={this.props.divStyle}>
        ...
        <img
          src={left}
          className="img-size-left"
          onClick={() => this.setVideo("left")}
        ...
        <img
          ...
          onClick={() => this.setVideo("right")}
          onMouseDown={() => this.setTimeVideo("right")}
          onMouseUp={() => this.setStopVideo()}
        ></img>
        <img
          src={down}
          className="img-size-down"
          onClick={() => this.setVideo("down")}
        ...
        <div className="img-radio-zoo">
          <img
            src={zoomin}
            className="img-size-zoomin"
            onClick={() => this.setVideo("zoomin")}
            onMouseDown={() => this.setTimeVideo("zoomin")}
            onMouseUp={() => this.setStopVideo()}
          ></img>
          <img
            src={zoomout}
            className="img-size-zoomout"
            onClick={() => this.setVideo("zoomout")}
