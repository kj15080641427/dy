...
class FloodSituation extends React.PureComponent {
    ...
    render() {
        ...
        const element = <Row>
            ...
            <Col span={2}>
                <Button type='primary' size='large' icon={<CloudDownloadOutlined />} onClick={downl}>导出</Button>
            </Col>
            <Col span={7}></Col>
        </Row>
        return (
            <>
                ...
                <br></br>
                <RainrAnnunciate element={element} dy={raindata.dy} z={raindata.z} tm={raindata.tm} kl={raindata.kl} gr={raindata.gr} hk={raindata.hk} lj={raindata.lj} ></RainrAnnunciate>
                <br></br>
                <Row>
                    <Col span={11}> <RiverAnnunciate dataSource={riverdata} loding={riverloding}></RiverAnnunciate></Col>
                    <Col span={2}><Divider type="vertical" /></Col>
                    <Col span={11}><WaterAnnunciate dataSource={pointdata} loding={pointloding}></WaterAnnunciate></Col>
                </Row>
