...
class Map extends React.PureComponent {
  ...
  createMap() {
    ...
    this.map.addTile({
      url: `https://t2.tianditu.gov.cn/vec_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=vec&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILECOL={x}&TILEROW={y}&TILEMATRIX={z}&tk=${this.mapKey}`,
      visible: true,
    ...
    this.map.startSelectFeature("water", (param) => {
      ...
      param = {
        ...param,
        id: param.siteWaterLevels[0].stcd,
