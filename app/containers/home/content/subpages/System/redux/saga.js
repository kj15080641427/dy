...
import { queryPermission, deletePermission, getBaseSite } from '@app/data/request';
import {
	getQueryPermissionType, changePermissionData,
	getQueryBaseSiteType, setBaseSiteData,
} from './types'
